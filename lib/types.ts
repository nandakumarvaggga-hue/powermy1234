...
export const TIER_CONFIG: Record<Tier, { color: string; bgColor: string; borderColor: string; label: string; range: string; description: string; glow: string }> = {
  DORMANT: {
    color: 'text-zinc-400',
...
export const CATEGORIES: Record<Category, { label: string; emoji: string; color: string; bgColor: string; borderColor: string; description: string; attributes: string[] }> = {
  ...
  wildcard: {
    ...
    attributes: ['aura', 'presence', 'energy', 'chaos'],
  },
};
